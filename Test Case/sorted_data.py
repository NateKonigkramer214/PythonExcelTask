...
def test_bubble_sort():
    ...
    # Check if the sorted data is in the correct order
    expected_sorted_prices = [800, 1000, 1200]
    assert sorted_prices == expected_sorted_prices, "Data is not sorted as expected"
